...
function InViewVideosGrid() {
  return (
    <div className="h-[80vh] w-full overflow-y-auto overflow-x-hidden bg-black">
      <div className="mb-[50vh] mt-[50vh] py-12 text-center text-sm text-white">Scroll down</div>
...
export default InViewVideosGrid;