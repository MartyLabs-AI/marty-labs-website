                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-5">
                        <div className="flex items-center justify-between gap-3">
                            ...
                            <div className="relative group/icon">
                                ...
                                />
                                <ArrowRight className="relative z-10 w-4 h-4 text-red-500/60 transition-transform duration-300 group-hover/icon:scale-110 group-hover/icon:translate-x-0.5" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                >
                    <div className="flex-1 space-y-6">
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-zinc-600 dark:text-zinc-400 tracking-tight transition-all duration-500 ease-out-expo group-hover:translate-y-[-2px] leading-relaxed">
                                {description}
                            </p>
                        </div>
                    ...
                    <div className="pt-6 mt-6 border-t border-zinc-200 dark:border-zinc-800">
                        <div
                            className={cn(
                                ...
                                "hover:from-red-500/10 hover:from-0% hover:via-red-500/5 hover:via-100% hover:to-transparent hover:to-100%",
                                "dark:hover:from-red-500/20 dark:hover:from-0% dark:hover:via-red-500/10 dark:hover:via-100% dark:hover:to-transparent dark:hover:to-100%",
                                "hover:scale-[1.02] hover:cursor-pointer"
                            )}
                            onClick={onStartClick}
                        >
                            <span className="text-sm font-medium text-zinc-900 dark:text-white transition-colors duration-300 group-hover/start:text-red-600 dark:group-hover/start:text-red-400">
                                Get Started
                            </span>
                            <div className="relative group/icon">
                                <div
                                ...
                                />
                                <ArrowRight className="relative z-10 w-4 h-4 text-red-500 transition-all duration-300 group-hover/start:translate-x-0.5 group-hover/start:scale-110" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <style jsx>{`
                @keyframes scale {
                    0% {
                        transform: scale(2);
                        opacity: 0;
                        box-shadow: 0px 0px 50px rgba(239, 68, 68, 0.5);
                    }
                    50% {
                        transform: translate(0px, -5px) scale(1);
                        opacity: 1;
                        box-shadow: 0px 8px 20px rgba(239, 68, 68, 0.5);
                    }
                    100% {
                        transform: translate(0px, 5px) scale(0.1);
                        opacity: 0;
                        box-shadow: 0px 10px 20px rgba(239, 68, 68, 0);
                    }
                }
            `}</style>
        </div>
